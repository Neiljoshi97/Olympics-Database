...
set identity_insert [EventMatch] on;


insert [EventMatch] ([MatchID],[EventPhase],[MatchDate],[OlympicDay],[OlympicID],[VenueID],[EventID])
...
set identity_insert [EventMatch] off;